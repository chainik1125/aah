...
define a yaml config file (or use the provided `aah/scripts/train_mnist/mnist.yaml`) and run

```bash
python aah/scripts/train_mnist/run_train_mnist.py <path_to_config_file>
```
